  ...
  <div>
    <v-navigation-drawer persistent :mini-variant="miniDrawer" v-model="showDrawer" fixed app>
      <v-layout column fill-height>
        <v-list>
          ...
          <v-list-tile to="/adminPage/dashboard">
            <v-list-tile-action>
              <v-icon>web</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
          ...
          <v-list-tile to="/adminPage/profile/view">
            <v-list-tile-action>
          ...
          <v-list-tile to="/adminPage/profile/edit">
            <v-list-tile-action>
              <v-icon>edit</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
          ...
          <v-list-tile to="/adminPage/profile/password">
            <v-list-tile-action>
        ...
        <v-list subheader v-show="hasAdminAccess">
          ...
          <v-list-tile to="/adminPage/admin/users/all">
            <v-list-tile-action>
              <v-icon>group</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
          ...
          <v-list-tile to="/adminPage/admin/users/create">
            <v-list-tile-action>
    ...
    <v-toolbar dark color="primary" app>
      ...
      <v-menu bottom left offset-y>
        ...
        <v-list>
          <v-list-tile to="/adminPage/profile">
            <v-list-tile-content>
              <v-list-tile-title>Profile</v-list-tile-title>
            </v-list-tile-content>
            <v-list-tile-action>
